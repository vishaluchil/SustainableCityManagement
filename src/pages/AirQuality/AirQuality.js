...
function AirQuality() {
      ...
      useEffect(async () => {
            const api_url = "https://cors-anywhere.herokuapp.com/https://api.waqi.info//map/bounds/?latlng=53.438027,-6.465774,53.271271,-6.093580&token=6bcfce6dc7b7e60a29aefc22f649a96ee0f6ce0d";
            ...
            allStations.forEach(station => {
                  getAllStations(station[0], station[1]).then(response => stationData.push(response))
            });
