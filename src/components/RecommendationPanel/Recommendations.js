    ...
    <>
        <Grid item container xs={12}>
          ...
          <div className="suggestions-wrapper">
                      ...
                      <div className = 'notifications-wrapper' style={{height:"40vh",
                       display:"block"}}>
                        {/* For Traffic */}
                        {
                        ...
                        Object.keys(urgentTraffic).map((key,i)=>{
                          ...
                          return(
                            <div key = {key} className="alert-severe">
                              ...
                              <i className="fa fa-exclamation-triangle faa-flash animated fa-blink"></i> Potential Traffic Jam at route {new_key}
                            </div>
                          );}
                          else{
                            return(null);
